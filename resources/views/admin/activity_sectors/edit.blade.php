    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h1 class="text-2xl font-bold text-gray-800 mb-6">Modifier un Secteur d'Activité</h1>
                
                <form action="{{ route('admin.activity-sectors.update', $sector->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-6">
                    ...
                    <div class="flex items-center mb-6">
                        <input type="checkbox" name="is_active" id="is_active" value="1" {{ $sector->is_active ? 'checked' : '' }} 
